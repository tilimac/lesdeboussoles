<?php
	// General
	$moxieManagerConfig['general.license'] = 'IQZV-YNFP-C6YA-II3O-ZAX7-BCHJ-2NSY-XMLQ';
	...
	// Filesystem
	$moxieManagerConfig['filesystem.rootpath'] = "localhost/app-v3/img/library/Backgrounnd";
	...
	$moxieManagerConfig['filesystem.directories'] = array(
            "Background" => array("filesystem.writable" => false),
            "ProgressBar" => array("filesystem.writable" => false)
	);
